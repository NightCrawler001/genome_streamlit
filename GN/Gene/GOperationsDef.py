...
class GOperationsDef:
    def __init__(self):
        ...
        self._FunctSlots = {
            ...
            2: [self.mul_o, self.sub_o, self.add_o, self.div_o, self.cos_o, self.sin_o],
            3: [self.mul_o, self.sub_o, self.add_o, self.log_o, self.sqrt_o, self.exp_o, self.cos_o, self.sin_o],
